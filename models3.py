...
class Stupwd(models.Model):
    ...
    pwd = models.CharField(max_length=500, blank=True, null=True)
...
class UserEvaluation(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('user_id', 'movie_id'), ('id', 'user_id', 'movie_id'),)
...
class Yiqinginfo(models.Model):
    shengfen = models.CharField(max_length=255)
    num = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'yiqinginfo'
        unique_together = (('id', 'shengfen'),)
